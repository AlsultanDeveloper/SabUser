...
const translations = {
  en: {
    ...
    wishlist: {
      ...
      emptyDescription: 'Add products you love to your wishlist and shop them later',
      startShopping: 'Start Shopping',
      addedDescription: 'Saved to your favorites',
      removedDescription: 'Item removed from your wishlist',
  ...
  ar: {
    ...
    wishlist: {
      ...
      emptyDescription: 'أضف المنتجات التي تحبها إلى قائمة أمنياتك وتسوقها لاحقاً',
      startShopping: 'ابدأ التسوق',
      addedDescription: 'تم حفظه في المفضلة',
      removedDescription: 'تم إزالته من قائمة الأمنيات',
    ...
    order: {
      ...
      signInToAddWishlist: 'يرجى تسجيل الدخول لإضافة عناصر إلى قائمة أمنياتك',
